...
const schema = new Schema({
    ...
    liveStatus: { type: String, default: "awaiting", enum: ["awaiting", "checkIn", "checkOut", "missed"] },
    status: { type: String, default: "draft", enum: ["draft", "published", "active", "completed", "rejected", "cancelled"] },
